...
@Database(entities = [OptionsEntity::class, StockEntity::class, MarketsEntity::class, StockSummaryEntity::class, OptionsSummaryEntity::class], version = 1, exportSchema = false)
